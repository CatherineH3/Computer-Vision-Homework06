...
If you look at my code, you'll also note that I tried an alternate method, which was successfully. It is temporarily commented out. It is a more concise method that does the same thing, but uses a grid and cv2.perspectiveTransform to compute all source coordinates at once and fill the output image in a single step.
